...
// 설정된 요청방식을 따른다. 브라우저 주소창에 주소를 입력하고 접근하는 경우,
// 요청방식은 GET이 된다.
...
public class UserServlet extends HttpServlet {
	 ...
	 * 
	 * HttpServletRequest : 브라우저가 보낸 모든 정보가 담겨 있는 개체
	 * HttpServletResponse : 서버에서 브라우저로 보내는 정보는 담는 객체
	*/
...
//	}
	...
	// GET 요처방식: 브라우저가 서버에게 데이터를 요청할 때 사용한다.
	...
	// POST 요처방식: 브라우저가 서버에게 데이터를 전송할 때 사용한다.
