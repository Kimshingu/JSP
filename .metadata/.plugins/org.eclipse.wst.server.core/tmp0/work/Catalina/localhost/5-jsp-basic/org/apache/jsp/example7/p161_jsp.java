 ...
 * Generated at: 2018-10-08 08:31:55 UTC
...
public final class p161_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("<body>\r\n");
      out.write("<body>\r\n");
      out.write("\t<!-- 문자열을 구분자와 함께 설정하면 구분자로 잘라서 배열을 만들고 그 배열을 사용한다. -->\r\n");
      out.write("\t");
  ...
  private boolean _jspx_meth_c_005fforTokens_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /example7/p161.jsp(14,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforTokens_005f0.setVar("car");
      // /example7/p161.jsp(14,1) name = items type = javax.el.ValueExpression reqTime = true required = true fragment = false deferredValue = true expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
      _jspx_th_c_005fforTokens_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/example7/p161.jsp(14,1) '소나타,포드,봉고,트럭,그렌져'",_jsp_getExpressionFactory().createValueExpression("소나타,포드,봉고,트럭,그렌져",java.lang.String.class)).getValue(_jspx_page_context.getELContext()));
      // /example7/p161.jsp(14,1) name = delims type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
