...
<body>
	...
	<p>4. ${message}</p>
	<!--
		JSP 수정 후 서버를 재기동 하지 않아도 사용자가 그 변화를 확인할 수 있다.
		이는 스크립트 프로그래밍의 특징으로써 JSP 코드 그대로 쓰는 것이 아니라
		서블릿 프레임워크가 Java로 변경한 후 사용하기 때문이다.
		JSP 스크립트 랭귀지 특성을 갖는다. 서블릿이 변경날짜를 체크해서
